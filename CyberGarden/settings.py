"""
Django settings for CyberGarden project.
...
SECRET_KEY = 'django-insecure-o-or0@@ebfl+@b3kzvn2$e(ok**hx!%lo+)odzo_rhk40*ngka'
...
WSGI_APPLICATION = 'CyberGarden.wsgi.application'
...
ALLOWED_HOSTS = ['*'] #чел звезду ебнул
